...
transaction() {
  ...
  prepare(acct: AuthAccount) {
    ...
    if acct.borrow<&RegistryNFTContract.Tenant>(from: /storage/NFTContract) == nil {
      ...
      acct.link<&RegistryNFTContract.Tenant{RegistryNFTContract.ITenant, RegistryContract.ITenantMinter}>(RegistryNFTContract.TenantPublicPath, target: RegistryNFTContract.TenantStoragePath)
    }
  }
